...
static const _LocomotionState_type_support_symbol_names_t _LocomotionState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hexapod_custom_msgs, msg, LocomotionState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hexapod_custom_msgs, msg, LocomotionState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hexapod_custom_msgs, msg, LocomotionState)() {
  return &::hexapod_custom_msgs::msg::rosidl_typesupport_c::LocomotionState_message_type_support_handle;
}
