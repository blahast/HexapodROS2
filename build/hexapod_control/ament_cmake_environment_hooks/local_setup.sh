...
: ${AMENT_CURRENT_PREFIX:="/home/hexapod/ros2_ws/install/hexapod_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hexapod_control/environment/library_path.sh"
